...
import type { RecallingScheduleEdit } from '@/schema/recallingSchedule'
import {
  RecallingFrequency,
...
export type RecallingRuleEditProps = {
  control: Control<RecallingScheduleEdit>
  setValue: UseFormSetValue<RecallingScheduleEdit>
}

export const RecallingRuleEdit = ({
  control,
  setValue,
}: RecallingRuleEditProps) => {
        ...
        <div className={styles.contents}>
          ...
          <label className={styles.option}>
            <input
              ...
              onClick={() => setValue(RecallingScheduleKey.EndDate, new Date())}
            />
